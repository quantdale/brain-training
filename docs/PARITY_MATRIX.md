...
| Games | Attention catalog | IMPLEMENTED | Visual Search (Phase 2) + Odd One Out (Phase 4) + Target Count (Wave 01) — 3 games |
...
| Games | Logic & Problem Solving catalog | IMPLEMENTED | Next in Sequence (Phase 2) + Code Cracker (Phase 4) + Rule Grid (Wave 01) — 3 games |
| Games | Flexibility catalog | IMPLEMENTED | Card Sort (Phase 2) + Color Stroop (Phase 4) + Cue Shift (Wave 01) — 3 games |
| Games | Spatial catalog | IMPLEMENTED | Mental Rotation (Phase 2) + Transform Match (Phase 4) + Grid Navigator (Wave 01) — 3 games |
...
| Progression | Achievements | IMPLEMENTED | Expanded catalog (milestone/volume/streak/perfect) with progress, claim, celebration |
...
| Progression | Streak freeze/recovery | IMPLEMENTED | Costs/limits + inventory + apply/claim + milestones + celebration |
