...
- Latest local checkpoint is committed at `4f3ad2d`; final push/CI confirmation remains blocked by the GitHub token's missing `workflow` scope, and persistence/recovery evidence remains NOT VALIDATED after the single bounded DB probe SIGSEGV.
## Ordered workstreams
