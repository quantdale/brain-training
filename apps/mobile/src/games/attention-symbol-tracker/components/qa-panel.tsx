/**
 * QaPanel — dev-only force-state controls for the Symbol Tracker game.
 * Generic shell is shared; the per-game `force-timeout` extra (skip the
 * observe countdown) renders through the shell's `extraActions`.
 */
