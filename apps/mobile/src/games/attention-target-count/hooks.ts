/**
 * Target Count game — dev-only QA hooks and tutorial lifecycle wiring.
 *
 * `createTargetCountQaForceStateHooks` implements the SDK `QaForceStateHooks`
...
export function createTargetCountQaForceStateHooks(
  dispatch: Dispatch<TargetCountAction>,
): QaForceStateHooks {
  return {
    gameId: GAME_ID,
    forceWin: () => {
...
/**
 * Tutorial lifecycle for the Target Count game. Uses the SDK reference lifecycle
 ...
 */
export function createTargetCountTutorialLifecycle(
