/**
 * Version metadata for the Word Scramble game.
 *
...
/** Scoring/normalization version — bump when `normalizeWordScrambleResult` changes. */
export const SCORING_VERSION = '1.1.0';

/**
 * Map a semantic version string to the integer recorded in the db:
 * the numeric major component. The full string versions always travel with the
 * raw result / diagnostic metadata, so no information is lost.
 */
