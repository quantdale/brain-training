...
import {
  createWordScrambleQaForceStateHooks,
...
describe('createWordScrambleQaForceStateHooks', () => {
  it('dispatches the matching reducer action for each hook', () => {
    ...
    const hooks = createWordScrambleQaForceStateHooks(dispatch);
  ...
  it('is bound to the game id and runs in dev builds', () => {
    const hooks = createWordScrambleQaForceStateHooks(jest.fn());
...
describe('createWordScrambleTutorialLifecycle', () => {
