/**
 * Memory game — dev-only QA hooks and tutorial lifecycle wiring.
 *
 * `createMemoryQaForceStateHooks` implements the SDK `QaForceStateHooks`
...
export function createMemoryQaForceStateHooks(
...
/**
 * Tutorial lifecycle for the Memory game. Uses the SDK reference lifecycle
 ...
 */
export function createMemoryTutorialLifecycle(
