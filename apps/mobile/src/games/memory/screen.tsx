 ...
 * only what is Memory-specific — the reducer wiring, the reveal pacing timer,
 ...
 * pacing; resuming re-schedules from the current tile. The board is covered
 * by the opaque shared `PauseOverlay` and hidden from the accessibility tree
 * while paused.
 */
