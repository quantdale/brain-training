...
export const TileGrid = memo(function TileGrid({ gridSize, testID, visualFor, disabled = false, onPressTile }: TileGridProps) {
  const side = Math.round(Math.sqrt(gridSize));
  return (
    <View style={styles.grid} testID={testID} accessibilityLabel="Memory board">
