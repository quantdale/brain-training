/**
 * Number Line Estimation game — dev-only QA hooks and tutorial lifecycle
 * wiring.
 *
 * `createNumberLineQaForceStateHooks` implements the SDK `QaForceStateHooks`
...
export function createNumberLineQaForceStateHooks(
  dispatch: Dispatch<NumberLineAction>,
): QaForceStateHooks {
  return {
    gameId: GAME_ID,
    forceWin: () => {
 ...
 */
export function createNumberLineTutorialLifecycle(
