/**
 * Visual Search game — dev-only QA hooks and tutorial lifecycle wiring.
 *
 * `createVisualSearchQaForceStateHooks` implements the SDK `QaForceStateHooks`
...
export function createVisualSearchQaForceStateHooks(
  dispatch: Dispatch<VisualSearchAction>,
): QaForceStateHooks {
  return {
    gameId: GAME_ID,
    forceWin: () => {
...
/**
 * Tutorial lifecycle for the Visual Search game. Uses the SDK reference
 ...
 * GAME_SDK.md).
 */
export function createVisualSearchTutorialLifecycle(
