/**
 * Pair Recall game — dev-only QA hooks and tutorial lifecycle wiring.
 *
 * `createPairRecallQaForceStateHooks` implements the SDK `QaForceStateHooks`
...
export function createPairRecallQaForceStateHooks(
  dispatch: Dispatch<PairRecallAction>,
): QaForceStateHooks {
  return {
    gameId: GAME_ID,
    forceWin: () => {
...
/**
 * Tutorial lifecycle for the Pair Recall game. Uses the SDK reference lifecycle
 ...
 */
export function createPairRecallTutorialLifecycle(
