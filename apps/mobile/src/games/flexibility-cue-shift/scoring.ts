/**
 * Scoring + normalization for the Cue Shift game.
 *
 * Raw scoring is game-owned; `normalizeFlexibilityCueResult` converts it to the
...
import type { FlexibilityCueDifficultyParams, FlexibilityCueRawResult } from './types';
...
export function perfectSessionScore(params: FlexibilityCueDifficultyParams): number {
...
/** SDK-conformant normalizer instance for the Cue Shift game. */
export const flexibilityCuePerformanceNormalizer: PerformanceNormalizer<FlexibilityCueRawResult> = {
  gameId: GAME_ID,
  normalize: normalizeFlexibilityCueResult,
};
