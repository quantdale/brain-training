/**
 * QaPanel — dev-only force-state controls for the Cue Shift game (campaign 006R).
 *
 ...
 * (`./components/qa-panel`) and testIDs stay stable. Cue Shift has no extra
 * per-game force actions, so `extraActions` is omitted.
 */
