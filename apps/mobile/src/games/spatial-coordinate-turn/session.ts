/**
 * Session result building + persistence for the Spatial Coordinate Turn game.
 *
...
export interface BuildRawResultInput {
  ...
  readonly params: SpatialCoordinateTurnDifficultyParams;
 ...
 */
export function buildSpatialCoordinateTurnRawResult(
  ...
  return {
    ...
    averageResponseMs,
    speedScore,
    positionTrials: input.stats.positionTrials,
    positionCorrect: input.stats.positionCorrect,
    directions: params.directions,
    rounds: params.rounds,
    minSteps: params.minSteps,
    maxSteps: params.maxSteps,
...
export interface BuildSessionRecordInput {
  ...
  readonly rawResult: SpatialCoordinateTurnRawResult;
 ...
 */
export async function persistSpatialCoordinateTurnSession(
