/**
 * PauseOverlay — pause surface for the Speed Color Match game.
 *
 * Satisfies the SDK `PauseOverlaySpec`: the surface is fully opaque so no
 * challenge pixel can peek through, and while paused the board's children are
 * hidden from the accessibility tree by the screen.
 */
