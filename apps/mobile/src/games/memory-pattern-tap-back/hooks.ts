/**
 * Pattern Tap Back game — dev-only QA hooks and tutorial lifecycle wiring.
 *
...
/**
 * Tutorial lifecycle for the Pattern Tap Back game. Uses the SDK reference
 * lifecycle over the provided store (an in-memory store by default).
 */
export function createTutorialLifecycle_(
