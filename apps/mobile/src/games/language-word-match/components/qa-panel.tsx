/**
 * QaPanel — dev-only force-state controls for the Word Match game.
 *
      ...
      {open ? (
        <View style={styles.panel} testID={testId(GAME_ID, 'qa-panel')}>
          <ThemedText type="caption" themeColor="textSecondary">
            Force-state hooks (assertDevOnly). Win/lose end the session;
            timeout expires the current round.
          </ThemedText>
