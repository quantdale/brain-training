/**
 * QaPanel — dev-only force-state controls for the Card Sort game (campaign 006R).
 *
 ...
 * (`./components/qa-panel`) and testIDs stay stable. The Card Sort game has no
 * extra per-game force actions, so `extraActions` is omitted.
 */
