/**
 * Odd One Out game — dev-only QA hooks and tutorial lifecycle wiring.
 *
 * `createOddOneOutQaForceStateHooks` implements the SDK `QaForceStateHooks`
...
export function createOddOneOutQaForceStateHooks(
  dispatch: Dispatch<OddOneOutAction>,
): QaForceStateHooks {
  return {
    gameId: GAME_ID,
    forceWin: () => {
...
/**
 * Tutorial lifecycle for the Odd One Out game. Uses the SDK reference
 ...
 * GAME_SDK.md).
 */
export function createOddOneOutTutorialLifecycle(
