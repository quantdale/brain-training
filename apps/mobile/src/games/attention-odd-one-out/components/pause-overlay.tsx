/**
 * PauseOverlay — pause surface for the Odd One Out game.
 *
 ...
 * paused the board's children are hidden from the accessibility tree by the
 ...
 * requirement is met with a solid themed surface instead (same trade-off as
 * the reference Memory game).
 */
  ...
  return (
    <View
      ...
      <ThemedText type="small" themeColor="textSecondary">
        The board is hidden and the timer is frozen.
      </ThemedText>
