/**
 * Session result building + persistence for the Spatial Transform Match game.
 *
...
export interface BuildRawResultInput {
  ...
  readonly params: SpatialTransformMatchDifficultyParams;
  readonly challengeRating: number;
  readonly seed: string;
  readonly stats: SpatialTransformMatchStats;
 ...
 */
export function buildRawResult(input: BuildRawResultInput): SpatialTransformMatchRawResult {
  const generatorInfo = {
...
export interface BuildSessionRecordInput {
  ...
  readonly rawResult: SpatialTransformMatchRawResult;
