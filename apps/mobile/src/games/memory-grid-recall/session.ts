/**
 * Session result building + persistence for the Grid Recall game.
 *
...
export interface BuildRawResultInput {
  ...
  readonly params: GridRecallDifficultyParams;
  readonly challengeRating: number;
  readonly seed: string;
  readonly stats: GridRecallStats;
 ...
 */
export function buildGridRecallRawResult(
  ...
  const generatorInfo = {
    ...
    initialTargetCount: input.params.initialTargetCount,
...
export interface BuildSessionRecordInput {
  ...
  readonly rawResult: GridRecallRawResult;
 ...
 */
export async function persistGridRecallSession(
  ...
  try {
    ...
    console.error(
      `[memory-grid-recall] failed to persist completed session ${record.id}`,
      error,
    );
