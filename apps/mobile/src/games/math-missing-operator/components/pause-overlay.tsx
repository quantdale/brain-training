/**
 * PauseOverlay — pause surface for the Math Missing Operator game.
 *
 ...
 * requirement is met with a solid themed surface instead (same approach as
 * the Memory game).
 */
  ...
  return (
    <View
      ...
      <ThemedText type="small" themeColor="textSecondary">
        The equation is hidden and the round timer is frozen.
      </ThemedText>
