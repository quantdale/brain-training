/**
 * Math Missing Operator game — dev-only QA hooks and tutorial lifecycle
 * wiring.
 *
 * `createMathMissingOperatorQaForceStateHooks` implements the SDK
...
export function createMathMissingOperatorQaForceStateHooks(
  dispatch: Dispatch<MathMissingOperatorAction>,
): QaForceStateHooks {
  return {
    gameId: GAME_ID,
    forceWin: () => {
...
/**
 * Tutorial lifecycle for this game. Uses the SDK reference lifecycle over the
 ...
 */
export function createMathMissingOperatorTutorialLifecycle(
