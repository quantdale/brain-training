/**
 * QaPanel — dev-only force-state controls for the Code Cracker game (campaign 006R task 10.3).
 *
 ...
 * (`./components/qa-panel`) and testIDs stay stable. This game has no extra
 * dev actions, so `extraActions` is omitted.
 */
