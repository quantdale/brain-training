/**
 * Tap Rush game — dev-only QA hooks and tutorial lifecycle wiring.
 *
 * `createTapRushQaForceStateHooks` implements the SDK `QaForceStateHooks`
...
export function createTapRushQaForceStateHooks(
  dispatch: Dispatch<TapRushAction>,
): QaForceStateHooks {
  return {
    gameId: GAME_ID,
    forceWin: () => {
...
/**
 * Tutorial lifecycle for the Tap Rush game. Uses the SDK reference lifecycle
 ...
 */
export function createTapRushTutorialLifecycle(
