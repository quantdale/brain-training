...
import type { CuratedSentence, ScrambledSentence, SentenceBuilderDifficultyParams } from './types';
...
export function generateRound(
  ...
  const differentCategory =
    prevCategory !== null
      ? pool.filter((s) => categoryDistance(s.category, prevCategory) >= MIN_CATEGORY_DISTANCE)
      : pool;
