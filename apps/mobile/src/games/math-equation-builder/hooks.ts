/**
 * Equation Builder game — dev-only QA hooks and tutorial lifecycle wiring.
 *
 * `createMathEquationBuilderQaForceStateHooks` implements the SDK `QaForceStateHooks`
...
export function createMathEquationBuilderQaForceStateHooks(
  dispatch: Dispatch<MathEquationBuilderAction>,
): QaForceStateHooks {
  return {
    gameId: GAME_ID,
    forceWin: () => {
...
/**
 * Tutorial lifecycle for the Equation Builder game. Uses the SDK reference lifecycle
 ...
 */
export function createMathEquationBuilderTutorialLifecycle(
